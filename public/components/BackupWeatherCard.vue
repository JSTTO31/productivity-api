<template>
    <v-card class="d-flex h-100 pb-0 flex-column text-white pa-8 align-center rounded-lg weather-card-animate-opacity"
        style="position: relative;">
        <div
            style="position: absolute;top:0 ;left: 0;width: 100%;height: 100%;background-image: url('https://source.unsplash.com/random/450x650/?weather-partly-cloudy');filter: brightness(90%); background-size: cover;background-repeat: no-repeat;z-index: 0;filter: brightness(90%);">
        </div>
